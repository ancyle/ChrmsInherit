...
public class IKLExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(IKLDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new IKLStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static IKLDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static IKLDateTimeConverter dateTimeConverter = new IKLStandardDateTimeConverter();

    public IKLExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public IKLExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new IKLMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=IKLHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,IKLExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=IKLHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
