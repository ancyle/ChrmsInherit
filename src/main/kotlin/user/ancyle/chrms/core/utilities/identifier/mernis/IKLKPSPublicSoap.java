...
public class IKLKPSPublicSoap
{
    ...
    public IKLKPSPublicSoap(){}

    public IKLKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public IKLKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        IKLExtendedSoapSerializationEnvelope envelope= new IKLExtendedSoapSerializationEnvelope(IKLExtendedSoapSerializationEnvelope.VER11);
